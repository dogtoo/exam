...
function modItem(src) {    
    ...
    $.post("ScMntMast_qryItem", req, function (res) {
        ...
        if (res.success) {
            ...
            $("#hEditQsId"        ).val(jrow.find("[name='qsId']" ).val());
            ...
            $("#itemList").datagrid({
                ...
                pagePosition: 'top',
                columns: [[
                    {field: 'fItemNo',   title: '編號',     width:  40},
                    {field: 'fItemDesc', title: '項目說明',     width: 250},
                    {field: 'fTip', title: '評分說明',     width: 250},
                    {field: 'fOptClass', title: '評分分類', width:200}
                ]],
                onStopDrag: function(){
                    reLoadItemSeq();
                },
    ...
    <div style="float: left; margin: 10px 0 0 10px;">
        <table>
            ...
            <tr>
                <td>教案代碼</td>
                <td>
                    <input id="editQsId"          class="easyui-textbox" style="width: 250px;" data-options="readonly: true"/>
                </td>
            </tr>
            <tr>
                <td>教案名稱</td>
        ...
        <table>
            ...
            <tr>
                ...
                <td colspan="4">
                    ...
                    <input type="hidden" id="hEditQsId"/>
                </td>
            </tr>
        </table>
    </div>
